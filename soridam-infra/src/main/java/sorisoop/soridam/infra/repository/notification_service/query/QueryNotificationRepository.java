package sorisoop.soridam.infra.repository.notification_service.query;

import static sorisoop.soridam.domain.notification_service.domain.QNotification.notification;
